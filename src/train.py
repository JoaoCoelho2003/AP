...
from models.numpyModels.dnn.layers import DenseLayer, DropoutLayer, BatchNormalizationLayer
from models.numpyModels.dnn.metrics import mse, accuracy
from models.numpyModels.dnn.activation import SigmoidActivation, ReLUActivation
from models.numpyModels.dnn.losses import FocalLoss
...
if not os.path.exists("trained_models/numpy"):
    os.makedirs("trained_models/numpy")

model.save(f"trained_models/numpy/{model_type}_weights.npz")
