<template>
  <div
    class="min-h-screen transition-all duration-500 relative overflow-hidden"
    :class="{
      dark: isDark,
  ...
  >
    <div class="fixed inset-0 pointer-events-none">
      ...
      <div
        class="absolute inset-0 bg-gradient-to-br from-primary-100/30 to-transparent dark:from-primary-900/20 dark:to-transparent"
      ></div>
      <div
        class="absolute -top-[40%] -right-[30%] w-[80%] h-[80%] rounded-full bg-gradient-to-br from-primary-200/20 to-purple-300/20 dark:from-primary-800/10 dark:to-purple-900/10 blur-3xl"
      ></div>
      <div
        class="absolute -bottom-[40%] -left-[30%] w-[80%] h-[80%] rounded-full bg-gradient-to-tr from-blue-200/20 to-primary-300/20 dark:from-blue-900/10 dark:to-primary-800/10 blur-3xl"
      ></div>
    </div>
      ...
      <main class="container mx-auto px-4 py-8">
        <div class="flex flex-col lg:flex-row gap-8">
          <div class="w-full lg:w-1/2">
            <div
              class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 transition-all duration-300 transform hover:shadow-2xl min-h-[500px]"
            >
              <div class="mb-8 relative group">
                <label
                  for="text-input"
                  class="block mb-2 font-medium text-gray-700 dark:text-gray-300 transition-all duration-300 group-focus-within:text-primary-600 dark:group-focus-within:text-primary-400"
                >
                  ...
                  >
                    <div class="max-h-60 overflow-y-auto">
                      <button
                        ...
                        :class="{
                          'bg-primary-50 dark:bg-primary-900/20': selectedModel === model.id,
                        }"
                      >
          ...
          <div class="w-full lg:w-1/2">
            <div class="min-h-[500px]">
              <transition name="fade" mode="out-in">
                ...
                <div
                  v-else
                  key="empty"
                  class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 transition-all duration-300 transform hover:shadow-2xl h-full flex flex-col items-center justify-center text-center"
                >
                  <div
                    class="w-24 h-24 mb-6 rounded-full bg-primary-100 dark:bg-primary-900/30 flex items-center justify-center"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <p class="text-gray-600 dark:text-gray-400 max-w-md mb-6">
                    Enter your text in the input field and click "Analyze Text" to see AI detection
                    results here.
                  </p>
                  <div class="flex flex-wrap justify-center gap-3">
                    <div
                      class="px-4 py-2 rounded-lg bg-primary-50 dark:bg-primary-900/20 text-primary-700 dark:text-primary-300 text-sm"
                    >
                      Fast Analysis
                    </div>
                    <div
            ...
            <transition name="fade">
              <div
                v-if="error"
                class="mt-8 p-5 bg-red-100/80 dark:bg-red-900/30 backdrop-blur-sm text-red-700 dark:text-red-300 rounded-xl text-center shadow-lg border border-red-200 dark:border-red-800/50 animate-pulse"
              >
                {{ error }}
              </div>
            </transition>
